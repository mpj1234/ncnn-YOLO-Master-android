...
Java_com_mpj_yolomaster_Yolo_loadModel(JNIEnv *env, jobject thiz, jobject assetManager,
                                       jint modelid,
                                       jint cpugpu) {
    // 这个modelid大于几就是用几的模型
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_mpj_yolomaster_Yolo_openCamera(JNIEnv *env, jobject thiz, jint facing) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_mpj_yolomaster_Yolo_closeCamera(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_mpj_yolomaster_Yolo_setOutputWindow(JNIEnv *env, jobject thiz, jobject surface) {
